...
num_cont = 5   # continuous variable number
...
z = z.sg_concat(target=[target_cval_1.sg_expand_dims(), target_cval_2.sg_expand_dims(), target_cval_3.sg_expand_dims(), 
                        target_cval_4.sg_expand_dims(), target_cval_5.sg_expand_dims()])
...
# run generator
#
def run_generator(num, x1, x2, x3, x4, x5, fig_name='sample.png', csv_name='sample.csv'):
