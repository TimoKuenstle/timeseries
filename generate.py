...
num_cont = 10   # continuous variable number
...
z = z.sg_concat(target=[target_cval_1.sg_expand_dims(), target_cval_2.sg_expand_dims(), target_cval_3.sg_expand_dims(), target_cval_4.sg_expand_dims(), target_cval_5.sg_expand_dims(), target_cval_6.sg_expand_dims(), target_cval_7.sg_expand_dims(), target_cval_8.sg_expand_dims(), target_cval_9.sg_expand_dims(), target_cval_10.sg_expand_dims()])
...
# run generator
#
def run_generator(num, x1, x2,x3,x4,x5,x6,x7,x8,x9,x10, fig_name='sample.png', csv_name='sample.csv'):
